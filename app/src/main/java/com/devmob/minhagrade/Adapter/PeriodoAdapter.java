...
import com.devmob.minhagrade.CourseActivity;
...
public class PeriodoAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        View view;
        if (context.getClass().equals(CourseActivity.class)){
            view = LayoutInflater.from(context).inflate(R.layout.spinner_periodo, parent, false);
        }else {
            view = LayoutInflater.from(context).inflate(R.layout.adapter_periodo, parent, false);
        }
